...
const styles = StyleSheet.create({
  ...
  emptyTitle: { ...fonts.h3, color: palette.textPrimary, marginBottom: spacing.xs },
  emptyText: { ...fonts.body, color: palette.textSecondary, textAlign: 'center' },
  legendRow: { flexDirection: 'row', marginBottom: spacing.lg, gap: 16, flexWrap: 'wrap' },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  legendDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: 'transparent' },
  legendText: { ...fonts.label, color: palette.textSecondary, textTransform: 'uppercase', fontSize: 10 },
  grid: { gap: GAP },
  ...
  cellDone: { backgroundColor: palette.successSoft, borderColor: palette.successSubtle },
  cellMissed: { backgroundColor: palette.warningSoft, borderColor: palette.warningSubtle },
  cellRest: { backgroundColor: palette.bgBase, opacity: 0.5 },
  cellToday: { backgroundColor: palette.primarySoft, borderWidth: 1.5, borderColor: palette.primary },
  cellNum: { fontSize: 10, fontWeight: '700', color: palette.textMuted },
  cellNumHL: { color: palette.success },
  cellNumMissed: { color: palette.warning },
  cellCheck: { fontSize: 8, color: palette.success, fontWeight: '900', marginTop: -2 },
});
